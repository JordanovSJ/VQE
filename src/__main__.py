...
if __name__ == "__main__":
    ...
    ansatz_element_2 = ExchangeAnsatz2(molecule.n_orbitals, molecule.n_electrons)
    ansatz_element_1 = ExchangeAnsatz1(molecule.n_orbitals, molecule.n_electrons, n_blocks=2)
    ansatz_elements = [ansatz_element_2, ansatz_element_1, ansatz_element_2, ansatz_element_1, ansatz_element_2, ansatz_element_1, ansatz_element_2, ansatz_element_1]
