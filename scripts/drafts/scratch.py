...
if __name__ == "__main__":
    ...
    qasm_1.append(DoubleExchange([0, 1], [2, 3], d_exc_correction=True, parity_dependence=False,
                                 rescaled_parameter=True).get_qasm([angle]))
    # qasm_1.append(QasmUtils.efficient_partial_exchange(angle, 0, 1))
    ...
    qasm_2.append(EfficientDoubleExchange([0, 1], [2, 3], parity_dependence=False, d_exc_correction=True,
                                          rescaled_parameter=True).get_qasm([angle]))
