...
if __name__ == "__main__":
    ...
    plt.plot(db_data_lih_uccsd['r'], db_data_lih_uccsd['E'], label=r'UCCSD', marker='+', linewidth=0.5, color='blue')
    plt.plot(db_data_lih_06['r'], db_data_lih_06['E'], label=r'QEB-ADAPT-VQE $\epsilon=10^{-6}$ Hartree', marker='+', linewidth=0.5, color='green')
    plt.plot(db_data_lih_08['r'], db_data_lih_08['E'], label=r'QEB-ADAPT-VQE $\epsilon=10^{-8}$ Hartree', marker='+', linewidth=0.5, color='red')
