...
if __name__ == "__main__":
    ...
    plt.plot(exc_08_df['r'], exc_08_df['fci_E'], label=r'$1^{st}$ excited, FCI energy', marker='+', linewidth=0.5, color='darkblue')
    ...
    plt.plot(g_06_df['r'], g_06_df['fci_E'], label=r'Ground state FCI energy', marker='+', linewidth=0.5, color='blue')
