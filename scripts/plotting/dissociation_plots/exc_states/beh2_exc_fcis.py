...
if __name__ == "__main__":
    ...
    ax.plot(df_fcis_2['r'], df_fcis_2['fci_E'], label='exc. st. 2', color='red', linewidth=0.5, alpha=0.75)
    ...
    ax.plot(df_fcis_9['r'], df_fcis_9['fci_E'], label='exc. st. 9', color='cyan', linewidth=0.5, alpha=0.75)
    ...
    axins.plot(df_fcis_2['r'], df_fcis_2['fci_E'], marker=marker, markersize=size, label='exc. st. 2', color='red', linewidth=0.25, alpha=0.5)
    ...
    axins.plot(df_fcis_9['r'], df_fcis_9['fci_E'],marker=marker, markersize=size, label='exc. st. 9', color='cyan', linewidth=0.25, alpha=0.5)
