...
if __name__ == "__main__":
    ...
    #
    plt.plot(db_data_beh2_qeuccsd['r'], db_data_beh2_qeuccsd['n_iters'], label=r'QUCC', marker='*', linewidth=0.5, color='blue')
    plt.plot(db_data_beh2_uccsd['r'], db_data_beh2_uccsd['n_iters'], label=r'UCC', marker='+', linewidth=0.5, color='red')
