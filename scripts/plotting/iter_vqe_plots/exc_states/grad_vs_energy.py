...
if __name__ == "__main__":
    ...
    db_n_1_bh2 = pandas.read_csv('../../../../results/iter_vqe_results/exc_states/BeH2_exc_1_iqeb_q_exc_n=1_r=1316_09-Jun-2021.csv')
    ...
    db_n_1_lih = pandas.read_csv('../../../../results/iter_vqe_results/exc_states/LiH_exc_1_iqeb_q_exc_n=1_r=1546_09-Jun-2021.csv')
    ...
    ax.plot(db_n_20_lih[df_col], db_n_20_lih['error'], label='LiH, $n_{QE}$=30', marker=marker, linewidth=linewidth, color='green')
