...
if __name__ == "__main__":
    ...
    db_iqeb = pandas.read_csv('../../../results/iter_vqe_results/LiH_iqeb_q_exc_n=1_r=1546_29-Mar-2021.csv')
    ...
    db_iqeb_3 = pandas.read_csv('../../../results/iter_vqe_results/LiH_iqeb_n=1_gsdqe_r=3_03-Dec-2020.csv')
    ...
    # ax.legend(loc=3, fontsize=9)#, bbox_to_anchor=(1,0.4))
