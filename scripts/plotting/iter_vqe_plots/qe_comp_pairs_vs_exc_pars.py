...
if __name__ == "__main__":
    ...
    indices_lih_no_comps  = numpy.arange(len(lih_db_no_comps))
    ...
    indices_beh2_no_comps = numpy.arange(len(beh2_db_no_comps))
    ...
    # ax.plot(indices_lih_no_comps, lih_db_no_comps['error'], label='1 parameter, $r=1.546 \AA$', marker=marker, linewidth=linewidth, color='lightgreen')
    ...
    ax.plot(indices_beh2_no_comps, beh2_db_no_comps['error'], label='1 parameter, $r=1.316 \AA$', marker=marker, linewidth=linewidth, color='lightgreen')
