...
if __name__ == "__main__":
    ...
    #
    # ax.plot(indices_iqeb, db_iqeb['error'], label='IQEB-VQE', marker=marker, linewidth=linewidth, color='blue')
    # ax.plot(indices_q_adapt, db_q_adapt['error'], label='qubit-ADAPT-VQE', marker=marker, linewidth=linewidth, color='green')
    # ax.plot(indices_adapt, db_adapt['error'], label='ADAPT-VQE', marker=marker, linewidth=linewidth, color='red')
    ...
    #
    # # axins.plot(indices_iqeb, db_iqeb['error'], label='IQEB-VQE', marker=marker, linewidth=linewidth, color='blue')
    # # axins.plot(indices_q_adapt, db_q_adapt['error'], label='qubit-ADAPT-VQE', marker=marker, linewidth=linewidth, color='green')
    # # axins.plot(indices_adapt, db_adapt['error'], label='ADAPT-VQE', marker=marker, linewidth=linewidth, color='red')
    #
