...
def iqeb_funli(input_r, input_molecule):
    # <<<<<<<<<ITER VQE PARAMETERS>>>>>>>>>>>>>>>>>>>>
...
for r in r_list:
    ...
    vqe_result = iqeb_funli(r, molecule)
...
df.to_csv('../results/zhenghao_testing/{}_dissociation_curve_{}.csv'.format(molecule.name, time_stamp_2))
