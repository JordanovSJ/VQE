...
var_pars = [1.0]*len(ansatz)  # ansatz_state.parameters
...
optimizer = 'BFGS'
gtol = 10e-4 # adaptive_bool = False
optimizer_options = {'gtol': gtol}  # {'adaptive': adaptive_bool}
