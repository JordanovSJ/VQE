...
from openfermion import FermionOperator as FE
...
if __name__ == "__main__":
    ...
    operator = openfermion.FermionOperator('[0^ 0 2^ 2]-[0^ 0 3^ 3]-[1^ 1 2^ 2]+[1^ 1 3^ 3]')  # TODO: TOVA trqbva da e klas openfermion.FermionicOperator
